		...
		<div id="grad">
				...
				<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
					...
					<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
						<div class="navbar-nav">
							...
							<a class="nav-item nav-link active" href="welcome.jsp">Display
								Message <span class="sr-only">(current)</span>
							</a> <a class="nav-item nav-link" href="deshboard.jsp">Success</a>
				...
				<h2>Application</h2>
					...
					<footer class="mx-auto bg-warning">
						<p class="text-white-50 bg-dark mx-auto bg-warning">@
							X-workz &reg;</p>
					</footer>
